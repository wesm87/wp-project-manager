...
import { camelCase, complement, compose, constant, defaultsDeep, getOr, identity, isEmpty, isEqual, isObjectLike, kebabCase, keys, merge, partialRight, pick, replace, snakeCase, startCase, startsWith, stubArray, stubFalse } from 'lodash/fp';
        ...
        return _regeneratorRuntime.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                base = this.getBasePath(type);
                files = getOr('', [type, 'link'], this.files);
